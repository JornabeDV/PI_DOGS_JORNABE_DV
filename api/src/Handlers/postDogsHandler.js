...
const {Temperaments} = require('../db');//Este modelo representa la tabla que contiene información sobre los temperamentos de los perros.-
...
const postDogsHandler = async (req, res) => {
    ...
    //Se extraen los datos necesarios para crear un nuevo perro a partir del cuerpo (body) de la solicitud HTTP. DESCTRUCTURING.-
    ...
    try {
        ...
        const newDog = await postDogs(name, minHeight, maxHeight, minWeight, maxWeight, life_span);// el postDogs(...) es una promesa que el await espera que se resuelva. La variable newDog contendrá el objeto del perro recién creado en la base de datos.-
